...
void DrawHistDouma_2D_flatArray(Int_t const Nhist, Int_t const Nhor, Int_t const Nvert, TH2D* const Raw[], TString const Title[], TString const xlabel, TString const ylabel, TString const zlabel, Bool_t const print, Bool_t const close)
{
