...
void Vacuum_Vessel_Geometry()												// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(61);
  Double_t Y_position = Doubles->GetBinContent(62);
  Double_t Z_position = Doubles->GetBinContent(63);
  
  Double_t Rotation_X = Doubles->GetBinContent(64);
  Double_t Rotation_Y = Doubles->GetBinContent(65);
  Double_t Rotation_Z = Doubles->GetBinContent(66);
  ...
  TString geoFileName = "../../Data/Geometry/Vacuum_Vessel.geo.root";							// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  t0->SetDx(X_position);											// NOTE: Change by C. A. Douma!
  t0->SetDy(Y_position);											// NOTE: Change by C. A. Douma!
  t0->SetDz(Z_position);											// NOTE: Change by C. A. Douma!
