...
void PSP_Geometry()													// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position_1 = Doubles->GetBinContent(81);
  Double_t Y_position_1 = Doubles->GetBinContent(82);
  Double_t Z_position_1 = Doubles->GetBinContent(83);
  Double_t Rotation_X_1 = Doubles->GetBinContent(84);
  Double_t Rotation_Y_1 = Doubles->GetBinContent(85);
  Double_t Rotation_Z_1 = Doubles->GetBinContent(86);
  
  Double_t X_position_2 = Doubles->GetBinContent(87);
  Double_t Y_position_2 = Doubles->GetBinContent(88);
  Double_t Z_position_2 = Doubles->GetBinContent(89);
  Double_t Rotation_X_2 = Doubles->GetBinContent(90);
  Double_t Rotation_Y_2 = Doubles->GetBinContent(91);
  Double_t Rotation_Z_2 = Doubles->GetBinContent(92);
  
  Double_t X_position_3 = Doubles->GetBinContent(93);
  Double_t Y_position_3 = Doubles->GetBinContent(94);
  Double_t Z_position_3 = Doubles->GetBinContent(95);
  Double_t Rotation_X_3 = Doubles->GetBinContent(96);
  Double_t Rotation_Y_3 = Doubles->GetBinContent(97);
  Double_t Rotation_Z_3 = Doubles->GetBinContent(98);
  ...
  TString geoFileName = "../../Data/Geometry/PSP.geo.root";								// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  //psp1
  dx = X_position_1; 													// NOTE: Change by C. A. Douma!
  dy = Y_position_1;													// NOTE: Change by C. A. Douma!
  dz = Z_position_1;													// NOTE: Change by C. A. Douma!
  
  TGeoRotation *gRot1 = new TGeoRotation();
  gRot1->RotateX(Rotation_X_1);					 							// NOTE: Change by C. A. Douma!
  gRot1->RotateY(Rotation_Y_1);												// NOTE: Change by C. A. Douma!
  gRot1->RotateZ(Rotation_Z_1);												// NOTE: Change by C. A. Douma!
  
  TGeoCombiTrans* pMatrix1 = new TGeoCombiTrans("", dx,dy,dz,gRot1);
  
  
  //psp2
  dx = X_position_2; 													// NOTE: Change by C. A. Douma!
  dy = Y_position_2;													// NOTE: Change by C. A. Douma!
  dz = Z_position_2;													// NOTE: Change by C. A. Douma!
  
  TGeoRotation *gRot2 = new TGeoRotation();
  gRot2->RotateX(Rotation_X_2);					 							// NOTE: Change by C. A. Douma!
  gRot2->RotateY(Rotation_Y_2);												// NOTE: Change by C. A. Douma!
  gRot2->RotateZ(Rotation_Z_2);												// NOTE: Change by C. A. Douma!
  
  TGeoCombiTrans* pMatrix2 = new TGeoCombiTrans("", dx,dy,dz,gRot2);
  
  
  //psp3
  dx = X_position_3; 													// NOTE: Change by C. A. Douma!
  dy = Y_position_3;													// NOTE: Change by C. A. Douma!
  dz = Z_position_3;													// NOTE: Change by C. A. Douma!
  
  TGeoRotation *gRot3 = new TGeoRotation();
  gRot3->RotateX(Rotation_X_3);					 							// NOTE: Change by C. A. Douma!
  gRot3->RotateY(Rotation_Y_3);												// NOTE: Change by C. A. Douma!
  gRot3->RotateZ(Rotation_Z_3);												// NOTE: Change by C. A. Douma!
