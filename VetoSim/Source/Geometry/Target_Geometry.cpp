...
void Target_Geometry()												// NOTE: Change by C. A. Douma!
{
  ...
  if (0 == strncmp(geoTag, "LeadTargetThick", 10)) ConstructGeometry1Thick(lead);  	//for s318
  if (0 == strncmp(geoTag, "LeadTargetThin", 10)) ConstructGeometry1Thin(lead);  	//for s318
  ...
  if (0 == strncmp(geoTag, "CTarget44", 7))    ConstructGeometry5_44(pMedCarbon);	//for s318
...
void ConstructGeometry1(TGeoMedium *lead)
{
  ...
  cout << "-I- R3BTarget Target type: Lead target (500mg/cm2) "<< endl;
  cout << endl;
  ...
  */
  ...
  dx = 1.500000;	//s318
  dy = 1.500000;	//s318
  dz = 0.008766520*500.0/199.0;     //s318: 199mg/cm2 = 0.17533040mm
  ...
  TGeoRotation *zero = new TGeoRotation("");
  TGeoCombiTrans* pGlobal = new TGeoCombiTrans("",0.0,0.0,0.0,zero);
  gTop->AddNode(keep, 0, pGlobal);
}

//void ConstructGeometry1(TGeoMedium *lead,  TGeoMedium *pMed2)
void ConstructGeometry1Thick(TGeoMedium *lead)
{
  // ===================================================================
  // NOTE: This section is added by C. A. Douma!
...
//void ConstructGeometry1(TGeoMedium *lead,  TGeoMedium *pMed2)
void ConstructGeometry1Thin(TGeoMedium *lead)
{
  // ===================================================================
  // NOTE: This section is added by C. A. Douma!
  ...
  */
  ...
  dx = 1.500000;	//s318
  dy = 1.500000;	//s318
  dz = 0.008766520*2200.0/199.0;     //s318: 199mg/cm2 = 0.17533040mm
  TGeoShape *pLeadTarget = new TGeoBBox("LeadTarget", dx,dy,dz);
  TGeoVolume* pleadTarget_log
    = new TGeoVolume("leadTarget_log",pLeadTarget, lead);
  pleadTarget_log->SetVisLeaves(kTRUE);
...
void ConstructGeometry5_44(TGeoMedium *pMedCarbon)
{
  // ===================================================================
  // NOTE: This section is added by C. A. Douma!
