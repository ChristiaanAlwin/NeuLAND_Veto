...
void MFI_Geometry()												// NOTE: Change by C. A. Douma!
{
  ...
  Double_t Module_Distance = Doubles->GetBinContent(77);
  ...
  pMatrix62 = new TGeoCombiTrans("", dx, dy, dz+Module_Distance, pMatrix7);					// NOTE: Change by C. A. Douma!
  ...
  if (MFI_Exists==2) {pMFILogWorld->AddNode(pMFILog, 1, pMatrix62);}							// NOTE: Change by C. A. Douma!
