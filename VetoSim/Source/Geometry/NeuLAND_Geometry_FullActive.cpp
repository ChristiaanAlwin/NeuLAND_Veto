...
void NeuLAND_Geometry()												// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t neuLAND_paddle_dimy   = 2.4999;    // half of the width [cm]
  Double_t neuLAND_paddle_dimz   = 2.4999;    // half of the depth [cm]
  Double_t neuLAND_depth_dim     = 150.;   // half detector depth [cm]
  Double_t neuLAND_gap_dim       = 0.00003;   // total detector depth [cm]
  Double_t neuLAND_wrapping1_dim = 0.00002;   // thickness of wrapping material [cm]
  Double_t neuLAND_wrapping2_dim = 0.00005;   // thickness of wrapping material [cm]
  ...
  TString geoFileName = "../../Data/Geometry/NeuLAND.geo.root";							// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
