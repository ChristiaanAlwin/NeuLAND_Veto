...
void ALADIN_Geometry()
{
  ...
  Double_t X_position = Doubles->GetBinContent(161);
  Double_t Y_position = Doubles->GetBinContent(162);
  Double_t Z_position = Doubles->GetBinContent(163);
  
  Double_t Rotation_X = Doubles->GetBinContent(164);
  Double_t Rotation_Y = Doubles->GetBinContent(165);
  Double_t Rotation_Z = Doubles->GetBinContent(166);
  ...
  TString geoFileName = "../../Data/Geometry/ALADIN.geo.root";									// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  top->AddNode(cell, 1, globaltrans);
