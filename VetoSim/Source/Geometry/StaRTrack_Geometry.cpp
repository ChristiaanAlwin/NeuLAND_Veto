...
TGeoRotation *fRefRot = new TGeoRotation();
...
void StaRTrack_Geometry()												// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(51);
  Double_t Y_position = Doubles->GetBinContent(52);
  Double_t Z_position = Doubles->GetBinContent(53);
  
  Double_t Rotation_X = Doubles->GetBinContent(54);
  Double_t Rotation_Y = Doubles->GetBinContent(55);
  Double_t Rotation_Z = Doubles->GetBinContent(56);
  ...
  TString geoFileName = "../../Data/Geometry/StaRTrack.geo.root"; 							// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  // StarTrack world (mother volume to have vacuum for Si tracker and air for CALIFA)  !!
   ...
   fRefRot->RotateX(Rotation_X);										// NOTE: Change by C. A. Douma!
   fRefRot->RotateY(Rotation_Y);										// NOTE: Change by C. A. Douma!
   fRefRot->RotateZ(Rotation_Z);										// NOTE: Change by C. A. Douma!
   TGeoCombiTrans *t0 = new TGeoCombiTrans("",X_position,Y_position,ShiftToWorldEdge+Z_position,fRefRot);	// NOTE: Change by C. A. Douma!
