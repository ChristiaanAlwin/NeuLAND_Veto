...
void DCH_Geometry()													// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(31);
  Double_t Y_position = Doubles->GetBinContent(32);
  Double_t Z_position = Doubles->GetBinContent(33);
  
  Double_t Rotation_X = Doubles->GetBinContent(34);
  Double_t Rotation_Y = Doubles->GetBinContent(35);
  Double_t Rotation_Z = Doubles->GetBinContent(36);
  ...
  TString geoFileName = "../../Data/Geometry/DCH.geo.root";								// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
  ...
  temp1->SetDx(X_position);											// NOTE: Change by C. A. Douma!
  temp1->SetDy(Y_position);											// NOTE: Change by C. A. Douma!
  temp1->SetDz(Z_position);											// NOTE: Change by C. A. Douma!
  temp1->RotateX(Rotation_X);											// NOTE: Change by C. A. Douma!
  temp1->RotateY(Rotation_Y);											// NOTE: Change by C. A. Douma!
  temp1->RotateZ(Rotation_Z);											// NOTE: Change by C. A. Douma!
