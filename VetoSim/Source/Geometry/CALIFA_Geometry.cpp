...
void CALIFA_Geometry()												// NOTE: Change by C. A. Douma!
{
  // =================================================================================
  ...
  Double_t X_position = Doubles->GetBinContent(11);
  Double_t Y_position = Doubles->GetBinContent(12);
  Double_t Z_position = Doubles->GetBinContent(13);
  
  Double_t Rotation_X = Doubles->GetBinContent(14);
  Double_t Rotation_Y = Doubles->GetBinContent(15);
  Double_t Rotation_Z = Doubles->GetBinContent(16);
  ...
  TString geoFileName = "../../Data/Geometry/CALIFA.geo.root";							// NOTE: Change by C. A. Douma!
  // --------------------------------------------------------------------------
