...
void GLAD_Geometry()														// NOTE: Change by C. A. Douma! NOTE: Air <--> vacuum shift has been made to put GLAD to Vacuum!
{
  // =================================================================================
  ...
  TGeoMedium* pMed2 = gGeoMan->GetMedium("vacuum");
  if ( ! pMed2 ) Fatal("Main", "Medium vacuum not found");
  // --------------------------------------------------------------------------
  ...
  t0->SetTranslation(X_position-25.0,Y_position,Z_position+DistanceToTarget+Correction+45.0);						// NOTE: Change by C. A. Douma! No shift in X... -30.0 fits chamber, but -10.0 fits beam!
  t0->RotateY(14.0);						                                                                // NOTE: Change by C. A. Douma! This used to be +7.3
  t0->RotateZ(180.0);
...
void ConstructSubPartEcrans(TGeoVolume* pWorld)
{
 ...
 // -- Mixture: vacuum
   TGeoMedium *pMed2 = gGeoManager->GetMedium("vacuum");
