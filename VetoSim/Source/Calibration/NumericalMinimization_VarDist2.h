void NumericalMinimization_VarDist2(Double_t *TheCuts, Double_t &kappa, Int_t const Abeam, Int_t const Zbeam) 
{
  ...
  ROOT::Math::Functor f(&WastedEfficiency_VarDist2, N_MAX);
