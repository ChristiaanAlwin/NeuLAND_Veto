void Full_VETO_Condition(Leaf_Structure* const TheLeafs, Inputs_Structure* const Inputs, Tree_Structure* AnaTree, Int_t const Event, Int_t const Counter, TRandom3* generator)
{
  ...
  // =============================================================================================
  // The purpose of this function is to VETO everything! Hence we must first set all
  // leafs to kTRUE and then compute the detected energy. The first thing is easy:
