...
void SetParameters()
{
  ...
  // ----------------------------------- TARGET:
  TObjString* Target_Material = new TObjString("LeadTarget"); // Target Target_Material choice. Replace the string with one of the following options;
  ...
  // ----------------------------------- TOF wall:
  Doubles->SetBinContent(41,-360.0);      	// TOF wall global x position [cm]. Default: -417.359574
  Doubles->SetBinContent(42,0.0);		// TOF wall global y position [cm]. Default:    2.4
  Doubles->SetBinContent(43,1410.0);    	// TOF wall global z position [cm]. Default:  960.777114
  
  Doubles->SetBinContent(44,0.0);		// TOF wall rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(45,-18.0);		// TOF wall rotation around y-axis [deg.] Default: -31.0
  ...
  Doubles->SetBinContent(129,1.3);		// VETO Scintillator bar thickness [cm].   Default:    1.2 (NeuLAND)
  ...
  Integers->SetBinContent(218,1000822080);     	// Particle ID code: particle species [int]. Default = 2112 (neutrons) NOTE: Check if the mass is added at the end of this file!
  ...
  Doubles->SetBinContent(212,0.499);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(213,0.501);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  Doubles->SetBinContent(220,187.1);		// z-coordinate of location of particle gun [cm]. Default = -200.0
  ...
  Integers->SetBinContent(201,250000);   	// Number of events in a single run [int]. Default = 100
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Pb208");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(201,5500.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Doubles->SetBinContent(344,83.0);             // Time cut to ignore primary particles above this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
  Doubles->SetBinContent(345,66.0);             // Time cut to ignore primary particles BELOW this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
  ...
  Integers->SetBinContent(405,0);		// If this bin is set to unity, only tracks aimed at the VETO are plotted. Default = 0
  Integers->SetBinContent(406,2112);		// PDG code that we select on in the Ken Miki plots and also in the Fired Bars OpenGL pictures (0 means all particles!) Default = 0
  Integers->SetBinContent(407,2);		// Selects the plane number for the NeuLAND content plots and the TOFvsEdep plots (also from Ken Miki). 0 = Default = entire NeuLAND
  ...
  Integers->SetBinContent(413,1);               // If this bin equals unity, only detected particles are counted in the vetf-runs.
  Integers->SetBinContent(414,1);               // If this bin equals unity, only triggered events are counted in the vetf-runs.
