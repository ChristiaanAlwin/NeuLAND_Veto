...
void SetParameters()
{
  ...
  Doubles->SetBinContent(212,0.349);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(213,0.351);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  Doubles->SetBinContent(214,0.0);		// Lower bound of angle with z-axis at which particles are emitted [deg.] Default = 0.0
  Doubles->SetBinContent(215,4.584e-3);	        // Upper bound of angle with z-axis at which particles are emitted [deg.] Default = 4.584 (80 mrad)
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Ni58");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(201,3580.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Doubles->SetBinContent(344,88.5);             // Time cut to ignore primary particles above this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
  Doubles->SetBinContent(345,68.5);             // Time cut to ignore primary particles BELOW this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
