...
void SetParameters()
{
  ...
  Doubles->SetBinContent(215,6.078);	        // Upper bound of angle with z-axis at which particles are emitted [deg.] Default = 4.584 (80 mrad)
  ...
  Doubles->SetBinContent(220,240.0);		// z-coordinate of location of particle gun [cm]. Default = -200.0
  ...
  Doubles->SetBinContent(344,72.0);             // Time cut to ignore primary particles above this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
  Doubles->SetBinContent(345,52.0);             // Time cut to ignore primary particles BELOW this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
