...
void SetParameters()
{
  ...
  Doubles->SetBinContent(201,3740.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Doubles->SetBinContent(344,89.0);             // Time cut to ignore primary particles above this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
  Doubles->SetBinContent(345,69.0);             // Time cut to ignore primary particles BELOW this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
