...
void SetParameters()
{
  ...
  Doubles->SetBinContent(83,-5.2-201.2);        // PSP detector 1 global z position [cm]. Default: -221.0
  ...
  Doubles->SetBinContent(89,-5.2-121.9);        // PSP detector 2 global z position [cm]. Default:  -89.0
  ...
  Doubles->SetBinContent(95,-5.2+87.9);         // PSP detector 3 global z position [cm]. Default:   94.1
  ...
  // ----------------------------------- TARGET:
  TObjString* Target_Material = new TObjString("LeadTargetThin"); // Target Target_Material choice. Replace the string with one of the following options;
  ...
  Doubles->SetBinContent(23,-5.2);		// Target global z position [cm]. Default:  0.0
  ...
  Doubles->SetBinContent(163,5.2-5.2);	        // ALADIN global z position [cm]. Default:   0.0
  ...
  // ----------------------------------- GFI:
  Doubles->SetBinContent(171,-68.326); 		// GFI global x position [cm]. Default:  0.0
  Doubles->SetBinContent(172,0.0);		// GFI global y position [cm]. Default:  0.0
  Doubles->SetBinContent(173,555.84-5.2);       // GFI global z position [cm]. Default:  0.0
  
  Doubles->SetBinContent(174,0.0);		// GFI rotation around x-axis [deg.] Default:  0.0
  Doubles->SetBinContent(175,-12.8);		// GFI rotation around y-axis [deg.] Default:  0.0
  ...
  // ----------------------------------- TOF wall:
  Doubles->SetBinContent(41,-278.51); 	        // TOF wall global x position [cm]. Default: -417.359574
  Doubles->SetBinContent(42,0.0);		// TOF wall global y position [cm]. Default:    2.4
  Doubles->SetBinContent(43,1481.0-5.2);        // TOF wall global z position [cm]. Default:  960.777114
  
  Doubles->SetBinContent(44,0.0);		// TOF wall rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(45,-12.8);		// TOF wall rotation around y-axis [deg.] Default: -31.0
  ...
  // ------------------------------------- MFI:
  Doubles->SetBinContent(71,-42.582); 		// MFI global x position [cm]. Default:  -63.82
  Doubles->SetBinContent(72,0.0);		// MFI global y position [cm]. Default:    0.0
  Doubles->SetBinContent(73,442.52-5.2);        // MFI global z position [cm]. Default:  520.25
  
  Doubles->SetBinContent(74,0.0);		// MFI rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(75,-12.8);		// MFI rotation around y-axis [deg.] Default: -13.5
  ...
  Doubles->SetBinContent(113,1299.2+9*2.5+5.0);	// NeuLAND global z position [cm]. Default:  1550.0
  ...
  Integers->SetBinContent(2,9); 		// NeuLAND number of Single Planes you want to use [int]. Default = 60
  ...
  Doubles->SetBinContent(123,1299.2+2.5);      // VETO global z position [cm]. Default:  1200.0
  ...
  Doubles->SetBinContent(202,0.549);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(203,0.551);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Ca48_rot_Pb");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(201,1900.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  ...
  Doubles->SetBinContent(303,1265.0);   	// z-location of front XY-plane for identification of primary particles [cm] Default = 600.0
  Doubles->SetBinContent(304,1330.0);   	// z-location of back XY-plane for identification of primary particles [cm] Default = 1700.0
  ...
  Integers->SetBinContent(309,100);             // Selects the VETO condition:
  ...
  Doubles->SetBinContent(333,-5.2);              // Z-coordinate of where the neutrons came from (Tracker VETO condition) [cm]. Default = 0.0 NOTE: Also used by the R3BNeutronTracker2D!
  ...
  Doubles->SetBinContent(339,-5.2);              // Z-coordinate of where the PROTONS came from (Tracker VETO condition) [cm]. Default = 0.0
  ...
  Integers->SetBinContent(407,3);		// Selects the plane number for the NeuLAND content plots and the TOFvsEdep plots (also from Ken Miki). 0 = Default = entire NeuLAND
