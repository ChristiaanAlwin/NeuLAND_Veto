...
void SetParameters()
{
  ...
  // ----------------------------------- TARGET:
  TObjString* Target_Material = new TObjString("CTarget44"); // Target Target_Material choice. Replace the string with one of the following options;
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Ca48_rot_C");   	// Determines the name of the output files of the simulation. Replace the string
