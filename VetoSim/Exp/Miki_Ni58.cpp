...
void SetParameters()
{
  ...
  Doubles->SetBinContent(83,-105.4-90.6);            // PSP detector 1 global z position [cm]. Default: -221.0
  ...
  Doubles->SetBinContent(89,-105.4-11.3);       // PSP detector 2 global z position [cm]. Default:  -89.0
  ...
  Doubles->SetBinContent(95,-105.4+185.5);      // PSP detector 3 global z position [cm]. Default:   94.1
  ...
  // ----------------------------------- TARGET:
  TObjString* Target_Material = new TObjString("LeadTargetThick"); // Target Target_Material choice. Replace the string with one of the following options;
  ...
  Doubles->SetBinContent(23,-105.4);		// Target global z position [cm]. Default:  0.0
  ...
  // ----------------------------------- ALADIN:
  // z position of 0.0 means entrance window is at z=117.5
  ...
  Doubles->SetBinContent(163,105.4-105.4);	// ALADIN global z position [cm]. Default:   0.0
  ...
  // ----------------------------------- GFI:
  Doubles->SetBinContent(171,-76.352); 		// GFI global x position [cm]. Default:  0.0
  Doubles->SetBinContent(172,0.0);		// GFI global y position [cm]. Default:  0.0
  Doubles->SetBinContent(173,652.75-105.4);     // GFI global z position [cm]. Default:  0.0
  
  Doubles->SetBinContent(174,0.0);		// GFI rotation around x-axis [deg.] Default:  0.0
  Doubles->SetBinContent(175,-15.0);		// GFI rotation around y-axis [deg.] Default:  0.0
  ...
  // ----------------------------------- TOF wall:
  Doubles->SetBinContent(41,-225.17); 	        // TOF wall global x position [cm]. Default: -417.359574
  Doubles->SetBinContent(42,0.0);		// TOF wall global y position [cm]. Default:    2.4
  Doubles->SetBinContent(43,1208.2-105.4);      // TOF wall global z position [cm]. Default:  960.777114
  
  Doubles->SetBinContent(44,0.0);		// TOF wall rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(45,-15.0);		// TOF wall rotation around y-axis [deg.] Default: -31.0
  ...
  // ------------------------------------- MFI:
  Doubles->SetBinContent(71,-49.693); 		// MFI global x position [cm]. Default:  -63.82
  Doubles->SetBinContent(72,0.0);		// MFI global y position [cm]. Default:    0.0
  Doubles->SetBinContent(73,553.26-105.4);      // MFI global z position [cm]. Default:  520.25
  
  Doubles->SetBinContent(74,0.0);		// MFI rotation around x-axis [deg.] Default:   0.0
  Doubles->SetBinContent(75,-15.0);		// MFI rotation around y-axis [deg.] Default: -13.5
  ...
  // ------------------------------------- NeuLAND:
  Doubles->SetBinContent(111,43.0); 		// NeuLAND global x position [cm]. Default:  0.0
  Doubles->SetBinContent(112,0.0);		// NeuLAND global y position [cm]. Default:  0.0
  Doubles->SetBinContent(113,1030.0-105.4+2.5);	// NeuLAND global z position [cm]. Default:  1550.0
  ...
  Doubles->SetBinContent(116,-90.0);		// NeuLAND rotation around z-axis [deg.] Default:  0.0
  
  Integers->SetBinContent(2,1);		// NeuLAND number of Single Planes you want to use [int]. Default = 60
  
  // ------------------------------------- VETO:
  Doubles->SetBinContent(121,43.0);		// VETO global x position [cm]. Default:     0.0
  Doubles->SetBinContent(122,0.0);		// VETO global y position [cm]. Default:     0.0
  Doubles->SetBinContent(123,1030.0-105.4-2.5);// VETO global z position [cm]. Default:  1200.0
  ...
  Doubles->SetBinContent(128,5.0);	        // VETO Scintillator bar width [cm].       Default:   15.6 (NeuLAND)
  Doubles->SetBinContent(129,5.0);		// VETO Scintillator bar thickness [cm].   Default:    1.2 (NeuLAND)
  ...
  Integers->SetBinContent(4,50); 		// VETO Number of bars within a single plane [int].        Default = 16
  ...
  Integers->SetBinContent(218,1000280580);     	// Particle ID code: particle species [int]. Default = 2112 (neutrons) NOTE: Check if the mass is added at the end of this file!
  Integers->SetBinContent(219,1); 		// Number of primary particles per event [int]. Default = 1
  Doubles->SetBinContent(202,0.699);		// Lower Bound op particle total energy! [GeV] Default = 0.0
  Doubles->SetBinContent(203,0.701);		// Upper Bound op particle total energy! [GeV] Default = 1.0
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Ni_rot_58");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Doubles->SetBinContent(201,2600.0);		// Magnetic field current [A]. Default = 4000.0 (for 1 GeV beams). 1920.0 works nice for 300 MeV beams.
  Integers->SetBinContent(224,0);		// Choice between GLAD or ALADIN magnetic field. 0=ALADIN and 1=GLAD. Delault = 1
  ...
  Integers->SetBinContent(256,1); 		// 0 or 1: 1 allows to use Crystal Ball, 0 does not. Default = 1
  ...
  Integers->SetBinContent(213,2); 		// 0 or 1: 1 allows to use MFI, 0 does not. Default = 1
  ...
  Integers->SetBinContent(254,1); 		// 0 or 1: 1 allows to use ALADIN, 0 does not. Default = 1
  Integers->SetBinContent(255,1); 		// 0 or 1: 1 allows to use GFI, 0 does not. Default = 1
  ...
  Doubles->SetBinContent(303,990.0-105.4);	// z-location of front XY-plane for identification of primary particles [cm] Default = 600.0
  Doubles->SetBinContent(304,1040.0-105.4);	// z-location of back XY-plane for identification of primary particles [cm] Default = 1700.0
  ...
  Doubles->SetBinContent(307,-85.0);     	// x-location of YZ-plane at TOF side for identification of primary particles [cm] Default = -150.0
  Doubles->SetBinContent(308,175.0);		// x-location of YZ-plane at other side for identification of primary particles [cm] Default = 150.0
  ...
  Integers->SetBinContent(309,1);               // Selects the VETO condition:
  ...
  Doubles->SetBinContent(333,-105.4);              // Z-coordinate of where the neutrons came from (Tracker VETO condition) [cm]. Default = 0.0 NOTE: Also used by the R3BNeutronTracker2D!
  ...
  Doubles->SetBinContent(339,-105.4);              // Z-coordinate of where the PROTONS came from (Tracker VETO condition) [cm]. Default = 0.0
  ...
  Integers->SetBinContent(407,1);		// Selects the plane number for the NeuLAND content plots and the TOFvsEdep plots (also from Ken Miki). 0 = Default = entire NeuLAND
