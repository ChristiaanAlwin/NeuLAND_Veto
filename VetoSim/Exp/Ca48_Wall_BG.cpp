...
void SetParameters()
{
  ...
  TObjString* Event_Generator = new TObjString("ascii");	// Decides which software is used to generate the primary particles.
								...
								// Default = "box"
  TObjString* Output_Name = new TObjString("Ca48_Wall_BG");   	// Determines the name of the output files of the simulation. Replace the string
  ...
  Integers->SetBinContent(253,3);               // 0 or 1: 1 allows to use the Dummy Vacuum chamber behind GLAD. Default = 0.
  ...
  Doubles->SetBinContent(344,95.0);             // Time cut to ignore primary particles above this TOF [ns]. Default = 1e10 NOTE: Also used by the digitizer!!!
