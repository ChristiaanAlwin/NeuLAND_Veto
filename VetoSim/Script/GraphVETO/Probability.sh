...
echo '### NOTE: like ./foto prob 3 or something, but not empty!'
echo ''
else
...
# Write the counter:
cd ../Source/Graphics/
sed -i "23 a Counter = $1;" ./Probability.cpp
sed -i '35 d' ./Probability.cpp
...
cd ../../Source/Graphics/
sed -i "30 a Series = ${Series};" ./Probability.cpp
sed -i '32 d' ./Probability.cpp

# Now that we did this, we can compile and run:
find ./ -type f ! -name "*.*" -exec rm -rf {} \;
rm -rf ./*.o
cp ../../Compile/Graphics/Probability ./Makefile
make clean
make -j 4
./Probability
