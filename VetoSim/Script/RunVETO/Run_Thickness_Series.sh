...
# and the thickness of the VETO is updated as well. This continues
...
echo '###########################################################################################'
echo ''
echo 'Running a series of big simulations for different VETO Thicknesses...'
...
then
  ...
  do
    ...
    echo ''
    root -l -q Update_VETOthickness.cpp
