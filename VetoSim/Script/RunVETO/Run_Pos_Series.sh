...
# and the z-position of the VETO is updated as well. This continues
...
echo '###########################################################################################'
echo ''
echo 'Running a series of big simulations for different VETO z-positions...'
