...
then
  ...
  rm -rf ./neuland/R3BNeulandDigitizrOld.h
  rm -rf ./neuland/R3BNeulandDigitizrOld.cxx
  ...
  cp ./Safe/R3BNeulandClusterFinder.cxx ./neuland/R3BNeulandClusterFinder.cxx
  cp ./Safe/R3BNeulandClusterFinder.h ./neuland/R3BNeulandClusterFinder.h
