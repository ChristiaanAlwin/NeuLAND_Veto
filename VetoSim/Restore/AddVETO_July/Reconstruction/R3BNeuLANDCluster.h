...
class R3BNeuLANDCluster : public TObject
{
 public:
  ...
  R3BNeuLANDCluster(R3BLandDigi* digi);

  // Constructor from 2 digis:
  R3BNeuLANDCluster(R3BLandDigi* digi1, R3BLandDigi* digi2);
  ...
  void Print();
  void AddDigi(R3BLandDigi* digi);
  void Merge(R3BNeuLANDCluster* Second, TClonesArray* fDigis);
  void Replace(R3BNeuLANDCluster* Second);
