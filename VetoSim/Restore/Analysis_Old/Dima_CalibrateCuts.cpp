...
void calibr_2D(Int_t beamE, Int_t Erel, Float_t Kappa)												// NOTE: Change by C. A. Douma
{
  ...
  d = 14;																	// NOTE: Change by C. A. Douma
  kappa = Kappa;
  TPstyle();

  Double_t cuts[5];																// NOTE: Change by C. A. Douma
  for (Int_t k = 0; k<5; ++k)															// NOTE: Change by C. A. Douma
  {																		// NOTE: Change by C. A. Douma
    cuts[k] = 0.0;																// NOTE: Change by C. A. Douma
  }  																		// NOTE: Change by C. A. Douma

  // ----- Files -----------------------------------------------------
  char strDir[] = "../../Data/Digitizer/";													// NOTE: Change by C. A. Douma
  TString inFile[4];
  TFile *file[4];
  TH2F *h[4];
  ...
  for(Int_t i = 0; i < 4; i++) {
    ...
    inFile[i] = TString(strDir) + TString(str) + ".root";											// NOTE: Change by C. A. Douma
...
void calibr_2D(Int_t beamE, Int_t Erel)
{
  ...
  //return;																	// NOTE: Change by C. A. Douma
