...
InitStatus R3BNeuLandClusterFinder::Init()
{
  ...
  fneuland_Nplanes = Integers->GetBinContent(2);
...
// ==>   200 MeV protons roughly have a 25 cm penetration depth in NeuLAND.
//       1) Some events have secondary interactions deeply inside NeuLAND.
//          These interactions are about 2m behind the intial proton track.
//       2) NeuLAND has gabs, which are NOT active material. If a proton
...
//          a second track generating more clusters in NeuLAND.
