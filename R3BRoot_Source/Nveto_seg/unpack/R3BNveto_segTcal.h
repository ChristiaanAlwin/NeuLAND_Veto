...
#ifndef R3BNVETO_SEGTCAL
#define R3BNVETO_SEGTCAL
 ...
 * This class reads Nveto_seg mapped items with TDC values and
 * produces time items with time in [ns]. It requires TCAL
 * calibration parameter_seg, which are produced in a separate
 * analysis run containing R3BNveto_segTcalFill task.
 */
class R3BNveto_segTcal : public FairTask
{
  ...
  public:
     ...
     */
    R3BNveto_segTcal(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BNveto_segTcal();
