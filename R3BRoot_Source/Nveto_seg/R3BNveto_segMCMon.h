 ...
 *          - Energy of non-neutron tracks in kVETO_SEG created by primary neutron interaction(s), by PID
 *          - Energy of neutron tracks created by primary neutron interaction
 *          - Total energy of non-neutron tracks in kVETO_SEG created by primary neutron interaction(s)
 *          - Total energy of non-neutron tracks in kVETO_SEG created by primary neutron interaction(s), by PID
 *          - IDs of tracks with a primary mother
 *          - Distribution of track mother IDs
 */

#ifndef R3BNVETO_SEGMCMON_H
#define R3BNVETO_SEGMCMON_H 1
...
class R3BNveto_segMCMon : public FairTask
{
  public:
    R3BNveto_segMCMon(const Option_t* option = "");
    ~R3BNveto_segMCMon();
  ...
  private:
    ...
    ClassDef(R3BNveto_segMCMon, 0)
};

#endif // R3BNVETO_SEGMCMON_H
