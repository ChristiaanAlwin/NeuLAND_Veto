#ifndef NVETO_SEGNVETOCLUSTRINGENGINEH
#define NVETO_SEGNVETOCLUSTRINGENGINEH
...
namespace Nveto_seg
{
    ...
    class NvetoClustringEngine
    {
      ...
      public:
         ...
         * unwanted results. */
        NvetoClustringEngine(){};
        NvetoClustringEngine(const BinaryPredicate& _f)
            : f(_f)
        {
        }
...
#endif // NVETO_SEGNVETOCLUSTRINGENGINEH
