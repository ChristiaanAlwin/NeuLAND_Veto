...
#ifndef R3BNEULANDCLUSTERFINDR_H
#define R3BNEULANDCLUSTERFINDR_H
...
class R3BNeuLANDClusterFindr : public FairTask {

 public:
     
  // Default constructor
  R3BNeuLANDClusterFindr();
  
  // Destructor
  virtual ~R3BNeuLANDClusterFindr();
 ...
 private:
  ...
  std::vector<R3BNeulandDigi*> fVectorDigi;
  ...
  ClassDef(R3BNeuLANDClusterFindr, 1);
};
