...
// -----         Ported from veto_seg02/detector/veto_seg/n_gen_det_cosmic1 on 11-2015       -----
// ---------------------------------------------------------------------------------------
...
void R3BNveto_segCal2HitPar::Exec(Option_t* option) {
   if (++fEventNumber % 100000 == 0)
      FairLogger::GetLogger()->Info(MESSAGE_ORIGIN, "R3BNveto_segCal2HitPar::Exec : Event: %8d,    accepted Events: %8d", fEventNumber, nData);
...
void R3BNveto_segCal2HitPar::FinishTask() {
   ...
   */
   ...
   TH1F* h_ecal = new TH1F("h_veto_seg_ecal", "Gain vs BarID", 2 * fPaddles * fPlanes, 0.5, 0.5 + fPaddles * fPlanes);
   h_veff->SetMaximum(15);
   h_veff->SetMinimum(0);
   h_veff->GetXaxis()->SetTitle("BarID");
