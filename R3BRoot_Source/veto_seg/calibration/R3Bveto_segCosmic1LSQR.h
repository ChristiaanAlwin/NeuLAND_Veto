#ifndef R3BVETO_SEGLSQR_H
#define R3BVETO_SEGLSQR_H
/*
* lsqr.h
...
*
*             Note:  If the user is not concerned about the parameter_seg
...
*
*                                   The vectors x and y are input parameter_seg in
*                                   both cases.
