...
#ifndef R3BPRIMPAT_SEG
#define R3BPRIMPAT_SEG
...
class R3BPrimPat_seg : public TObject
{
 public:
  R3BPrimPat_seg();
  R3BPrimPat_seg(Int_t pdg, Double_t px, Double_t py, Double_t pz,
	      Double_t x, Double_t y, Double_t z, Double_t t,
	      Double_t A, Double_t M);
  virtual ~R3BPrimPat_seg();
