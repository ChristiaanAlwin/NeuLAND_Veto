#ifndef R3BNEUTRONTRAK_SEGR_SEG_H
#define R3BNEUTRONTRAK_SEGR_SEG_H 1
...
class R3BNeutronTrak_segr_seg : public FairTask
{

 public:

  /** Default constructor **/  
  R3BNeutronTrak_segr_seg();
  ...
  R3BNeutronTrak_seg* AddHit(TVector3 pos_in, TVector3 pos_out,
  ...
  // Algorithm
  TClonesArray* fNeutronTrak_segs;
  ...
  ClassDef(R3BNeutronTrak_segr_seg,1);
