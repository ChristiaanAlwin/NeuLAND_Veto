void r3bveto_segreco(Int_t nNeutrons = 4, Int_t nEvents = 100, Int_t beamE = 600, Int_t Erel = 500)
{
  Int_t d;
  d = 15;
  ...
  R3BNeutronTrak_segr2D_seg* tracker  = new R3BNeutronTrak_segr2D_seg();
