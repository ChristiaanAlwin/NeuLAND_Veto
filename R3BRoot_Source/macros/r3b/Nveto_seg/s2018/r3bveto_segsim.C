...
void r3bveto_segsim(Int_t nNeutrons = 4, Int_t nEvents = 100, Int_t beamE = 600, Int_t Erel = 500)
{
  Int_t d;
  d = 15;
  ...
  detGeo.Add(new TObjString("SCINTNVETO_SEG"),  new TObjString(det));
