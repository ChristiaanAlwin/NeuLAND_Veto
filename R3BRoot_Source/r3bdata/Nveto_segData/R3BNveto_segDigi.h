#ifndef R3BNVETO_SEGDIGI_H
#define R3BNVETO_SEGDIGI_H
...
class R3BNveto_segDigi : public TObject
{
  public:
    R3BNveto_segDigi()
        : fPaddle(0)
    ...
    R3BNveto_segDigi(const Int_t paddle,
                   const Double_t TdcL,
                   const Double_t TdcR,
                   const Double_t time,
                   const Double_t QdcL,
  ...
  public:
    ClassDef(R3BNveto_segDigi, 1)
};

// Support easy printing with R3BNveto_segDigi mydigi; cout << mydigi;
std::ostream& operator<<(std::ostream&, const R3BNveto_segDigi&);

#endif // R3BNVETO_SEGDIGI_H
