...
TVector3 R3BNveto_segPoint::GetMomentum() const
{
    TVector3 v;
...
TVector3 R3BNveto_segPoint::GetPosition() const
{
    TVector3 v;
    Position(v);
    return v;
...
ostream& operator<<(ostream& os, const R3BNveto_segPoint& point)
{
    os << "R3BNveto_segPoint: Nveto_seg Point in Paddle " << point.GetPaddle() << " with light yield "
...
void R3BNveto_segPoint::Print(const Option_t*) const { std::cout << *this; }

ClassImp(R3BNveto_segPoint)
