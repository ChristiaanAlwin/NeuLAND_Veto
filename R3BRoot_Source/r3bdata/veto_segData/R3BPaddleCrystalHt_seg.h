...
// -------------------------------------------------------------------------
/**  R3BPaddleCrystalHt_seg.h
 **/

#ifndef R3BPADDLECRYSTALHT_SEG_H
#define R3BPADDLECRYSTALHT_SEG_H

#include "TObject.h"
#include "TVector3.h"
#include "FairHit.h"

class R3BPaddleCrystalHt_seg : public FairHit
{

 public:

  /** Default constructor **/
  R3BPaddleCrystalHt_seg();
  /** Copy constructor **/
  R3BPaddleCrystalHt_seg(const R3BPaddleCrystalHt_seg&);
  /** Destructor **/
  virtual ~R3BPaddleCrystalHt_seg();

  R3BPaddleCrystalHt_seg& operator=(const R3BPaddleCrystalHt_seg&) { return *this; }
 ...
 protected:
  ...
  ClassDef(R3BPaddleCrystalHt_seg,1)
