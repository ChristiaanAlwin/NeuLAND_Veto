...
// -----   Default constructor   -------------------------------------------
R3Bveto_segPoint::R3Bveto_segPoint()
  : FairMCPoint(),
...
R3Bveto_segPoint::R3Bveto_segPoint(Int_t trackID, Int_t detID, Int_t box, Int_t sector,
...
// -------------------------------------------------------------------------
R3Bveto_segPoint::R3Bveto_segPoint(const R3Bveto_segPoint& right)
  : FairMCPoint(right),
...
// -----   Public method Print   -------------------------------------------
void R3Bveto_segPoint::Print(const Option_t* opt) const
{
  cout << "-I- R3Bveto_segPoint: VETO_SEG Point for track " << fTrackID
...
Double_t R3Bveto_segPoint::GetX(Double_t z) const
{
...
Double_t R3Bveto_segPoint::GetY(Double_t z) const
{
...
Bool_t R3Bveto_segPoint::IsUsable() const
{
  Double_t dz = fZ_out - fZ;
