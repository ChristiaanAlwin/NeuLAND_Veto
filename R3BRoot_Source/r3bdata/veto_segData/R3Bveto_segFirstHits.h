// -------------------------------------------------------------------------
// -----                  R3Bveto_segFirstHits header file                 -----
// -----                    Created 20/02/1  by M.Heil                 -----
// -------------------------------------------------------------------------


/**  R3Bveto_segFirstHits.h
 **/


#ifndef R3BVETO_SEGFIRSTHITS_H
#define R3BVETO_SEGFIRSTHITS_H
...
class R3Bveto_segFirstHits : public TObject
{

 public:

  /** Default constructor **/
  R3Bveto_segFirstHits();
  R3Bveto_segFirstHits(Double_t x0, Double_t y0, Double_t z0, Double_t t0,
  ...
  /** Copy constructor **/
  R3Bveto_segFirstHits(const R3Bveto_segFirstHits&);

  /** Destructor **/
  virtual ~R3Bveto_segFirstHits();

  R3Bveto_segFirstHits& operator=(const R3Bveto_segFirstHits&) { return *this; }
 ...
 protected:
  ...
  ClassDef(R3Bveto_segFirstHits,1)
